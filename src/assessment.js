...
const context1 = (myFn, context, param1, param2) =>{
...
const context2 = (myFn, context, params) =>{
...
const context3 = (myFn, context) =>{
  let newFunc = myFn.bind(context);
  return newFunc;
}
...
// #10  ###################
// # Closure 1
// Write a function called sentenceMachine.  It takes in a parameter called partOne.  It returns a function called sentenceSmasher.
...
function compareValues(para1, para2){
  if (typeof para1 === typeof para2){
    return 'Exact match';
  } else if(typeof para1 !== typeof para2 && para1 == para2){
